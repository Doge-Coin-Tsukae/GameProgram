...
public:
	...
	void SetObject(D3DXVECTOR3 Pos, D3DXVECTOR3 Scl)
	{
		if (live == false)
		{
			PosObj = Pos;
...
HRESULT Object_Initialize(void)
{
	...
	//ブロックの設置
	g_Box[0].SetObject(D3DXVECTOR3(5000, 100, 0), D3DXVECTOR3(1.0f, 10.0f, 50.0f));
	g_Box[1].SetObject(D3DXVECTOR3(-5000, 100, 0), D3DXVECTOR3(1.0f, 10.0f, 50.0f));
	g_Box[2].SetObject(D3DXVECTOR3(0, 100, 5000), D3DXVECTOR3(50.0f, 10.0f, 1.0f));
	g_Box[3].SetObject(D3DXVECTOR3(0, 100, -5000), D3DXVECTOR3(50.0f, 10.0f, 1.0f));
	g_Box[4].SetObject(D3DXVECTOR3(5000, 100, 0), D3DXVECTOR3(1.0f, 10.0f, 50.0f));
	return S_OK;
}
